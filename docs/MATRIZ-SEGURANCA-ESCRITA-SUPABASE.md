...
| `public.pedidos_artes` | Qualquer campo | `UPDATE`, `INSERT`, `DELETE` | `BLOQUEADO` | Mapeamento e controle de versões das artes serão integrados na finalização em etapa futura. | Alto | Não aplicável. | Permanente nesta etapa | Mantido bloqueado. |
