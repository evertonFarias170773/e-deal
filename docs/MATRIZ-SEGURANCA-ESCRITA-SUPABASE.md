...
| `public.produtos` | Whitelist operacional, valores e fiscal: `nomeReal`, `categoria`, `formato`, `descricao`, `personalizacao`, `apelidos`, `ativo`, `is_estoque`, `is_variacao`, `nivelSeg`, `fraseCons`, `prazo`, `peso`, `valorUnt`, `valorFixo`, `valor_custo`, `cod_beneficio`, `ncm`, `descri_ncm`, `cest`, `origem`, `cod_origem`, `cod_bar`, `und_medida`, `is_multiplo`, `cfop_interno`, `cfop_interestadual`, `unidade_comercial`, `unidade_tributavel`, `icms_origem`, `icms_situacao_tributaria`, `pis_situacao_tributaria`, `cofins_situacao_tributaria`, `informacoes_fiscais` | `UPDATE` | `LIBERADO` | Edição real expandida para valores comerciais e dados fiscais informativos, usando `id_produto` como chave segura e sem permitir alteração de `id_produto`. | Alto | SQL de validação do produto com todos os campos fiscais e comerciais liberados. | `2026-05-28` / Fase 4 | `peso` permanece em gramas. Campos numéricos usam conversão segura. Não há validação SEFAZ/NF-e nesta etapa. |
