...
- A permissão `propostas.complementar` nasce **sem dono** (só o coringa `*` do Super Administrador a enxerga) e só é concedida a perfis na última etapa (E10). As etapas intermediárias podem ir ao ar sem que um vendedor crie complementos antes de o fluxo estar inteiro.
