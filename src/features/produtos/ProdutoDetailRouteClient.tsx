...
type ProdutoDetailRouteClientProps = {
  idProduto: number;
};

export function ProdutoDetailRouteClient({ idProduto }: ProdutoDetailRouteClientProps) {
    ...
    return (
      <section className="rounded-3xl border border-orange-200 bg-orange-50 p-6 text-orange-800">
        ...
        <p className="mt-2 text-sm">
          Não foi possível carregar este produto em public.produtos. Volte para a listagem e tente novamente.
        </p>
        <Link
          href="/produtos"
