 ...
 *   - flag ON e pergunta livre de leitura → agent loop (inclusive orçamento
 *     avulso por CEP — a tool cotacao_avulsa_cep cobre o fluxo sem cliente;
 *     o legado fica apenas como fallback técnico de erro na rota).
 */
