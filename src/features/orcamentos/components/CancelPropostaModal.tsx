          ...
          <div className="rounded-2xl border border-red-200 bg-red-50 p-4 text-red-800 flex gap-3 items-start">
            ...
            <div className="text-xs">
              ...
              <p className="mt-1 leading-relaxed">
                Você está prestes a cancelar esta proposta. Cobranças locais pendentes vinculadas também serão
                canceladas. É necessário preencher um motivo para auditoria.
              </p>
            </div>
          </div>
