    ...
    <div className="space-y-6">
      ...
      <ResponsiveList<Proposta>
        ...
        columns={[
          ...
          { header: "Total", cell: (proposta) => formatCurrency(proposta.resumo.valorTotal), align: "right" },
          { header: "Cob.", cell: (proposta) => getCobrancaLabel(proposta.cobrancaStatus), align: "center" },
        ...
        renderCard={(proposta) => (
          <article key={proposta.id} className="rounded-3xl border border-[#d7e5e8] bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 space-y-2 text-sm text-slate-600">
              ...
              <p>Cob.: {getCobrancaLabel(proposta.cobrancaStatus)}</p>
