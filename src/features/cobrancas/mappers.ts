...
export function mapSupabasePagamentoV2RowToCobranca(row: SupabasePagamentoV2Row): Cobranca | null {
  ...
  const cobranca: Cobranca = {
    ...
    cartao_parcelas: undefined,
    cartao_taxa_percentual: undefined,
    cartao_valor_taxa: undefined,
    cartao_valor_final: tipoCobranca === "CARD_PARCELADO" ? valor : undefined,
    cartao_checkout_id: undefined,
    cartao_checkout_url: tokenPublico ? resolveUrlPublica(row, tokenPublico) || undefined : undefined,
    cartao_status: resolveCartaoStatus(tipoCobranca, status),
